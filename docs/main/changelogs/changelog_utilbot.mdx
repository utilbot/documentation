...
With over 17.000 Additions and only 800 removals the new Version is now released. It has been a long time since the new Features were only available on Canary because we were waiting for [discord.js](https://discord.js.org) to release v13. So heres a short Summary of all the Changes:

<span class="cl-added">New features</span>

##### Globals
- **Interactions**: Interaction Support (Slash Commands, Message Components: Buttons and SelectMenus)
